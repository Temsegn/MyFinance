...
class _AnalyticsPageState extends State<AnalyticsPage> {
  ...
  Map<String, double> _computeCategorySpending() {
    ...
    switch (_selectedFilter) {
      ...
      case 'Custom':
        if (_customStartDate == null || _customEndDate == null) {
          startDate =
              now.subtract(const Duration(days: 365)); // Fallback to 1 year
          endDate = now;
        } else {
    ...
    final filteredTransactions = _sampleTransactions.where((transaction) {
      ...
      final withinDateRange = transactionDate.isAfter(startDate) &&
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: _selectedFilter == 'Year'
                          ? Colors.black
                          : Colors.grey,
                      fontWeight: _selectedFilter == 'Year'
                          ? FontWeight.bold
                          : FontWeight.normal,
                    ),
                  ),
                    ...
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, meta) {
                          final category =
                              categorySpending.keys.elementAt(value.toInt());
                  ...
                  barTouchData: BarTouchData(
                    ...
                    touchTooltipData: BarTouchTooltipData(
                      ...
                      getTooltipItem: (group, groupIndex, rod, rodIndex) {
                        final category =
                            categorySpending.keys.elementAt(group.x.toInt());
                ...
                GestureDetector(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 16,
                      color:
                          _selectedFilter == 'All' ? Colors.black : Colors.grey,
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 16,
                          color: _selectedFilter == 'Food'
                              ? Colors.black
                              : Colors.grey,
                          fontWeight: _selectedFilter == 'Food'
                              ? FontWeight.bold
                              : FontWeight.normal,
                        ),
                      ),
                    ...
                    GestureDetector(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 16,
                          color: _selectedFilter == 'Shopping'
                              ? Colors.black
                              : Colors.grey,
                          fontWeight: _selectedFilter == 'Shopping'
                              ? FontWeight.bold
                              : FontWeight.normal,
                        ),
                      ),
                    ...
                    GestureDetector(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 16,
                          color: _selectedFilter == 'Transport'
                              ? Colors.black
                              : Colors.grey,
                          fontWeight: _selectedFilter == 'Transport'
                              ? FontWeight.bold
                              : FontWeight.normal,
                        ),
                      ),
  ...
  void _showTransactionDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text(
              _editingIndex == null ? 'Add Transaction' : 'Edit Transaction'),
          content: Form(
            key: _formKey,
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _buildTransactionCard(
                          ...
                          iconColor:
                              _getColorForCategory(transaction['category']),
